...
const playSurah = (surah) => {
    ...
    const deskripsiAyat = `<div class="row mt-2 deskripsi-surah">
                            ...
                            <button id="play-surah" class="btn btn-primary mt-3">Play</button>
                            <button id="stop-surah" class="btn btn-danger mt-3">Stop</button>
                            </div>
                            </div>`;
    ...
    quranDetail(surah.nomor).then((ayat) => {
        ...
        ayatList.forEach((ayah, index) => {
            const ayatHTML = `<div class="row mt-4 ayat">
                              ...
                              <button class="btn btn-outline-secondary" data-audio="${ayah.audio['01']}" data-ayat-index="${index}">${ayah.nomorAyat}</button>
                              </div>
                              </div>`;
